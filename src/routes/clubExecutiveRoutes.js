...
router.get('/events/:eventId/registrations', clubExecutiveController.getEventRegistrations);
...
router.put('/announcements/:announcementId', validate(announcementValidation.announcement), clubExecutiveController.updateAnnouncement);
