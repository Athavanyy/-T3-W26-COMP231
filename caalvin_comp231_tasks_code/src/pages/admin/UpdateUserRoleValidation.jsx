...
export default function UpdateUserRoleValidation() {
  ...
  return (
    ...
    >
      <section className="wire-grid three" style={{ marginBottom: '24px' }}>
        <article className="wire-card">
          ...
          <div className="form-actions">
            <Link className="wire-button" to="/admin/users/manage">Open</Link>
          </div>
        </article>
        <article className="wire-card">
          <div>
            <h2>Approve Clubs</h2>
            <p>Review pending clubs and approve them to become active.</p>
          </div>
          <div className="form-actions">
            <Link className="wire-button" to="/admin/clubs/approve">Open</Link>
          </div>
        </article>
      </section>
